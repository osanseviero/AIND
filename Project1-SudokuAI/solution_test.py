...
diagonal_sudoku = solution.grid_values(diagonal_grid)

class TestDiagonalSudoku(unittest.TestCase):
    def test_solve(self):
        print(solved_diag_sudoku == solution.solve(diagonal_sudoku))
        self.assertEqual(solution.solve(diagonal_sudoku), solved_diag_sudoku)
